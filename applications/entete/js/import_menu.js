...
$("#navH").empty();
	$.each(file,function(index,noeud){
		...
		menu+="'./applications/presentation/presentation.html'";
		menu+=')"; > <img src="./applications/entete/images/p_home.gif" width="31" height="30" alt="" border="0"/> </a> </li>';
		$("#tabs").append(menu);
		var menu='';
		var menu2='';
...
menu2+='</li>';
		...
		$("#tabs").append(menu).bind("click",
								function(event){
									...
									charge_Entete("./applications/entete/json/menu.json",onglet_select);   
